...
setFadeAnimation();
        ...
        addSlide(AppIntroFragment.newInstance("We Train you", "We train you how to react in various emergency situations.", R.drawable.firstaid, Color.parseColor("#10a7ff")));
